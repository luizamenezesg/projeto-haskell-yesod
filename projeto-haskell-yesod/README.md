...
O TypeStore mostra como Haskell pode ser usado em aplicacoes web completas. Yesod fornece seguranca de tipos nas rotas e nos handlers. Persistent cria as entidades Haskell e gera migrations para SQLite. Hamlet, Lucius e Julius separam a camada visual.

O diferencial teorico esta em Type Families: elas permitem associar tipos diferentes a categorias diferentes no nivel do compilador. Assim, regras do dominio ficam expressas no sistema de tipos, reduzindo erros e tornando o codigo mais claro.
